...
function showItem(data) {
    ...
    isDone.innerText = "IsDone? " + data.status;
...
function displayEditForm(id) {
    const item = tasks.find(item => item.userId === id);
    document.getElementById('edit-name').value = item.username;
    document.getElementById('edit-isDone').checked = item.status;    AgentId
